...
def exec_python(**kwargs):
    ...
    *
    ...
    results = hook.get_records(sql_query)
    print(f"Results from Aurora: {results}")
...
with DAG(
        dag_id='6_tasks_aurora1', # unique identifier for the DAG
...
task_start >> task_exec_python_1 >> task_end